			...
			{isLoading ? (
				...
				<div className="flex flex-col lg:flex-row mt-8 mb-8 items-center lg:items-start">
					<div className="block mr-5 w-full">
						{/* {products && (
							<div
								className="grid items-center py-3 mb-6 text-[#232323] font-medium md:text-lg lg:text-xl bg-[#E2F4FF] sticky top-0 z-10"
								style={{
				...
				>
					...
					<p className="font-bold text-4xl my-5">Your Cart is Empty</p>
				</div>
			)}
		</Container>
	)
